...
export default class MovieDetails extends Component {
        ...
        this.scheduleNotif = (title, notifyDate) => {
            ...
            */
            ...
            PushNotification.localNotificationSchedule({
                ...
                bigText: title + ' is releasing soon. Make sure you have booked your seats!', // (optional) default: "message" prop
                ...
                title: title + ' is out soon!', // (optional)
    ...
    render() {
        const { showDate, date, maximumDate, title } = this.state;
        return (
            <ImageBackground blurRadius={2}
                ...
                {showDate &&
                    <DateTimePicker
                        ...
                        mode="date"
                        display="default"
                        onChange={(event, date) => this.setDate(event, date, title)}
                    />
                }
            </ImageBackground>
        );
